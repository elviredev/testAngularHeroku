...
export class PortailService {
  ...
  getAllApplis() {
    return this.httpClient.get<Applis>('/applis');
  }

  getAllUsers() {
    return this.httpClient.get('/userApps');
  }
  ...
  getUserById(id): Observable<User> {
    console.log('id: ', id);
    return this.httpClient.get<User>('/userApps/' + id);
  }

  getRoles() {
    return this.httpClient.get<Roles>('/roleApps');
  }

  getRoleByUser(user: User) {
    return this.httpClient.get<Roles>('/userApps/' + user.id + '/roles');
  }

  getApplisByUser(user: User) {
    return this.httpClient.get<Applis>('/userApps/' + user.id + '/applis');
  }
